...
class EstrategiaModoUmidoTest {

    private final EstrategiaModoUmido estrategia = new EstrategiaModoUmido();
    ...
    void deveSuspenderIrrigacaoComChuvaPrevista() {
        ...
        Irrigacao resultado = estrategia.calcularIrrigacao(40.0, clima, milho);
