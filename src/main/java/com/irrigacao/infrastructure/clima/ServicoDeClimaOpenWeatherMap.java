...
public class ServicoDeClimaOpenWeatherMap implements ServicoDeClima {
    private static final Logger logger = LoggerFactory.getLogger(ServicoDeClimaOpenWeatherMap.class);

    private final ClienteOpenWeatherMap client;
    private DadosClimaticos cache;

    public ServicoDeClimaOpenWeatherMap(ClienteOpenWeatherMap client) {
        this.client = client;
    }
